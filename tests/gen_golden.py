...
CASES = [
    ("자해 시드", "민수가 죽고 싶다고 말했고 손목에 흉터가 보였다.", "A"),
    ("학폭 시드", "나가 따돌림을 당하고 욕설과 협박을 들었다고 한다.", "A"),
    ("아동학대 시드", "다의 팔에 멍이 보였고 집에 가기 싫다며 맞았다고 말했다.", "A"),
    ("특수+학폭 시드", "라는 발달이 느린 편인데 괴롭힘과 따돌림을 당했다.", "B"),
    ("녹색대조", "마는 평소처럼 친구들과 어울리고 수업에 잘 참여했다.", "A"),
    ("일반신호", "지수가 점심을 거르고 혼자 앉아 말이 없었다.", "A"),
    ("오탐:보호자", "보호자에게 연락함.", "A"),
    ("오탐:맞았", "시험 답이 맞았다.", "A"),
    ("오탐:멍하니", "멍하니 창밖을 봤다.", "A"),
    ("오탐:의미없", "의미 없는 숙제를 했다.", "A"),
    ("오탐:서울", "서울에서 전학 옴.", "A"),
]

out = []
for name, text, school in CASES:
    r = assess(text, school)
    out.append({"name": name, "text": text, "school": school,
